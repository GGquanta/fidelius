...
- 条与页同高 36px，激活不改变高度、不加 padding。矮视口页签不压缩，由主栏滚动，不拿纸面去挤页签栏
...
- 纸张顶角拉平：`border-radius: 0 0 18px 18px`，只有一层面 `--elev-3`。空记录时随主栏剩余高度拉伸到视口底，不用固定最小高度撑出滚动；内容更高时纸张跟着长，由主栏滚动。页签栏不压缩
